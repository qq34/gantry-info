...
import static com.eagle.cloud.route.utils.idgenerator.TimeUtil.*;
...
public class InstaIdGenerator {
	...
	public synchronized long nextId(long tag) {
		...
		return (timestamp << (totalBitCount - timestampBitCount)) | ((tag % regionModelVal) << (totalBitCount - timestampBitCount - regionBitCount)) | sequence;
	}
}
