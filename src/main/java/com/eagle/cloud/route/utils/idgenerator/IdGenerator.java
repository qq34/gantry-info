package com.eagle.cloud.route.utils.idgenerator;
...
/**
 * 数值型id生成器 https://github.com/thinwind/numerical-id-generator
 * Java实现数值型ID生成器 https://www.jianshu.com/p/d76e86fdf045
 * snowflake的JAVA版本(分布式唯一ID生成器) https://www.oschina.net/code/snippet_147955_25122
 * Twitter Snowflake https://blog.yxwang.me/2012/08/twitter-snowflake/
 * Instagram 的ID生成策略[翻译] http://www.cnblogs.com/yjl49/archive/2012/04/16/2452210.html
 * snowflake的id产生方案，全局唯一，时间有序 https://github.com/twitter/snowflake
 * @class: IdGenerator
 * @package: com.eagle.common.util.idgenerator
 * @description: 数值型id生成器
 * @author wzhz
 * @date 2019年5月8日 下午5:47:54
 */
public class IdGenerator {
	 ...
	 * </ul>
	 * @param year 年
	 * @param month 月份 与Calendar#MONTH一致，从0开始，到11结束
	 * @see Calendar#MONTH
